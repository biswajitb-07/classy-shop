...
export const playNotificationSound = () => {
  void playToneSequence("user-notification", [
    { frequency: 760, duration: 0.07, gain: 0.04, type: "triangle" },
    { frequency: 1020, duration: 0.1, gain: 0.045, type: "triangle", gap: 0.06 },
    { frequency: 1320, duration: 0.12, gain: 0.04, type: "triangle", gap: 0.07 },
  ]);
};
