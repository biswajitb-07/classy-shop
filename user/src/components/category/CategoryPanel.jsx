    ...
    <>
      ...
      <aside
        className={`fixed top-0 left-0 z-50 h-screen w-[18rem] 
          ${isDark ? "bg-slate-950 text-slate-100" : "bg-white"} shadow-2xl transform transition-transform duration-300 ease-in-out overflow-y-scroll scrollbar-red
      ...
      >
        <div className="flex flex-col justify-start gap-2 py-3 px-2">
          ...
          <div className="flex items-center justify-between px-3 py-4">
            <h2 className={`text-lg font-semibold ${isDark ? "text-slate-200" : "text-gray-500"}`}>
              Shop By Categories
            </h2>
            <button
