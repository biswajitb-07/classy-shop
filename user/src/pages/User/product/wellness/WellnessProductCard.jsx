// File guide: WellnessProductCard source file.
...
const WellnessProductCard = ({ products = [], isLoading = false }) => {
  ...
  if (isLoading) return <WellnessProductCardSkeleton />;
  if (!products)
    return (
          ...
          return (
            ...
            >
              <div className="relative group overflow-hidden">
                <img
                  onClick={() => navigate(`/wellness/wellness-product-details/${p._id}`)}
                  src={p.image[0]}
                  alt={p.name}
                ...
                {p.image[1] && (
                  <img
                    onClick={() =>
                      navigate(`/wellness/wellness-product-details/${p._id}`)
                    }
                    src={p.image[1]}
                    alt={p.name}
...
const WellnessProductCardSkeleton = () => (
