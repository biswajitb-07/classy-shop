// File guide: Electronics source file.
...
const Electronics = () => {
  ...
  const { data, isLoading, isError, refetch } = useGetElectronicItemsQuery();
  ...
  if (isError) {
    return (
      <ErrorMessage
        title="Failed to load electronic products"
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-2xl font-semibold">
                {normalizeForDisplay(
                  thirdcategory || subcategory || "Electronic"
                )}
              </h1>
