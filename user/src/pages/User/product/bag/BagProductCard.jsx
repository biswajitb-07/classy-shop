// File guide: BagProductCard source file.
...
const BagProductCard = ({ products = [], isLoading = false }) => {
  ...
  if (isLoading) return <BagProductCardSkeleton />;
  if (!products)
    return (
