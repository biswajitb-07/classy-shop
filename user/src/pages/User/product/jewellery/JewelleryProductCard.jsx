// File guide: JewelleryProductCard source file.
...
const JewelleryProductCard = ({ products = [], isLoading = false }) => {
  ...
  if (isLoading) return <JewelleryProductCardSkeleton />;
  if (!products)
    return (
          ...
          return (
            ...
            >
              <div className="relative group overflow-hidden">
                <img
                  onClick={() => navigate(`/jewellery/jewellery-product-details/${p._id}`)}
                  src={p.image[0]}
                  alt={p.name}
                ...
                {p.image[1] && (
                  <img
                    onClick={() =>
                      navigate(`/jewellery/jewellery-product-details/${p._id}`)
                    }
                    src={p.image[1]}
                    alt={p.name}
