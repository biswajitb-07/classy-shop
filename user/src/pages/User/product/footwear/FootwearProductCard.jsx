// File guide: FootwearProductCard source file.
...
const FootwearProductCard = ({ products = [], isLoading = false }) => {
  ...
  if (isLoading) return <FootwearProductCardSkeleton />;
  if (!products)
    return (
...
const FootwearProductCardSkeleton = () => (
