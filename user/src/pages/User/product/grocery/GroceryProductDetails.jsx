// File guide: GroceryProductDetails source file.
...
const GroceryProductDetails = () => {
  const { data, isLoading } = useGetGroceryItemsQuery();
  ...
  const product =
    !isLoading &&
    data?.groceryItems?.find((item) => String(item._id) === productId);
        ...
        <div className="flex flex-col xl:flex-row gap-5 md:gap-7">
          ...
          <div className="flex-1 flex flex-col gap-3 sm:gap-4">
            ...
            <p className="mt-2 text-gray-700 text-xs sm:text-sm tracking-wider">
              {product.description ||
                "This grocery product is selected for everyday freshness, value, and convenience."}
            </p>
