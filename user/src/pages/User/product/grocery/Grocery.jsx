// File guide: Grocery source file.
...
const Grocery = () => {
  ...
  const { data, isLoading, isError, refetch } = useGetGroceryItemsQuery();
  ...
  if (isError) {
    return (
      <ErrorMessage
        title="Failed to load grocery products"
        message="We couldn’t fetch the grocery items right now. Please check your internet connection or try again."
        onRetry={refetch}
      />
    );
  }
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-2xl font-semibold">
                {normalizeForDisplay(thirdcategory || subcategory || "Grocery")}
              </h1>
