// File guide: GroceryProductCard source file.
...
const GroceryProductCard = ({ products = [], isLoading = false }) => {
  ...
  if (isLoading) return <GroceryProductCardSkeleton />;
  if (!products)
    return (
          ...
          return (
            ...
            >
              <div className="relative group overflow-hidden">
                <img
                  onClick={() => navigate(`/grocery/grocery-product-details/${p._id}`)}
                  src={p.image[0]}
                  alt={p.name}
                ...
                {p.image[1] && (
                  <img
                    onClick={() =>
                      navigate(`/grocery/grocery-product-details/${p._id}`)
                    }
                    src={p.image[1]}
                    alt={p.name}
...
const GroceryProductCardSkeleton = () => (
