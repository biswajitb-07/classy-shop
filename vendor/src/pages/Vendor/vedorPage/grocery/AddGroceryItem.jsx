// File guide: AddGroceryItem source file.
// This file belongs to the vendor app architecture and has a focused responsibility within its module/folder.
import { useState } from "react";
import { useAddGroceryItemMutation } from "../../../../features/api/grocery-product/groceryApi";
import {
  FaPlus,
  FaTimes,
  FaImage,
...
const AddGroceryItem = ({ onClose, refetch, categoryData }) => {
  ...
  const [addProduct, { isLoading }] = useAddGroceryItemMutation();
