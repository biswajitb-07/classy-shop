// File guide: AddJewelleryItem source file.
// This file belongs to the vendor app architecture and has a focused responsibility within its module/folder.
import { useState } from "react";
import { useAddJewelleryItemMutation } from "../../../../features/api/jewellery-product/jewelleryApi";
import {
  FaPlus,
  FaTimes,
  FaImage,
...
const AddJewelleryItem = ({ onClose, refetch, categoryData }) => {
  ...
  const [addProduct, { isLoading }] = useAddJewelleryItemMutation();
