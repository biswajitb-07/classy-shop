      ...
      <div className="w-full max-w-6xl bg-white rounded-3xl overflow-hidden shadow-2xl flex flex-col lg:flex-row">
        ...
        <div className="auth-light-surface lg:w-1/2 p-8 sm:p-12 flex flex-col justify-center text-slate-900">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#1f2937] mb-2">Admin Control Center</h1>
            <p className="text-[#6b7280]">Sign in to manage platform operations and vendor workflows</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {isLoading ? <AuthButtonLoader /> : "Enter Admin Panel"}
            </button>
          </form>
