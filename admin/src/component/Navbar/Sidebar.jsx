              ...
              >
                <div className="overflow-hidden">
                  <div className="mt-3 grid gap-3">
                    <div 
                      onClick={() => navigateTo("/community/admins")}
                      className={`rounded-2xl border px-4 py-3 cursor-pointer transition-colors ${communityCardClass(
                        location.pathname === "/community/admins",
                        "users"
                      )}`}
                    >
                      <div className="flex items-center gap-3">
                        <div className={`rounded-xl p-2 shadow-sm bg-white ${location.pathname === "/community/admins" ? "text-black" : isDark ? "text-slate-200" : "text-violet-600"}`}>
                          <FiShield size={18} />
                        </div>
                        <div>
                          <p className={`text-xs font-semibold uppercase tracking-[0.14em] ${communityCardTextClass(location.pathname === "/community/admins", "users")}`}>
                            Admins
                          </p>
                          <p className={`text-lg font-black ${communityValueClass(location.pathname === "/community/admins")}`}>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className={`rounded-xl p-2 shadow-sm bg-white ${location.pathname === "/delivery-partners" ? "text-black" : isDark ? "text-slate-200" : "text-emerald-600"}`}>
                          <Bike size={18} />
                        </div>
                        <div>
                          <p className={`text-xs font-semibold uppercase tracking-[0.14em] ${communityCardTextClass(location.pathname === "/delivery-partners", "vendors")}`}>
                            Delivery
                          </p>
                          <p className={`text-lg font-black ${communityValueClass(location.pathname === "/delivery-partners")}`}>
                            {summary?.totalDeliveryPartners ?? 0}
                          </p>
                        </div>
                      </div>
                    </div>
